	...
	<div class="wrap">
		...
		<div class="row">
			...
			<table class="table">
				...
				<tr>
					<th style="border-top:0px;"><label> Seat<label></th>
					<td style="border-top:0px;">
					  <a class="input-block-level input-medium" href="seat.php">check Availability</a>
				  </td>
				</tr>
				<tr>
				...
				<tr>
					<td style="border-top:0px;"><input class="btn btn-info" type="submit" value="OK" onclick="viewSeats()"></td>
		...
		<!-- display train -->
			<div class="span8 well">
				...
				<tr>
					...
					<th style="width:65px;border-top:0px;"> Originate. </th>
					<th style="width:55px;border-top:0px;"> Destination. </th>
					<th style="width:70px;border-top:0px;"> Arrival. </th>
